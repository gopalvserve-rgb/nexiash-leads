...
// Nexiash single-tenant build: only the Education pack is shipped.
// (Real Estate / other industry packs were stripped during the
// multi-tenant → single-tenant conversion.)
